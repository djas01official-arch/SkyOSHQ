...
- The model page currently lists standard text pricing of **$2.00 per 1M input tokens**, **$0.20 per 1M cached input tokens**, and **$12.00 per 1M output tokens**. These values differ from the point-in-time ADR comparison and must be re-verified before each controlled run.
